...
export default function MentorSection() {
  ...
  const CONTENT = [
    ...
    {
      title:'Bharat Pulse - Turn Trivia Into Teaching',
      desc:'One powerful India story every day, with a linked exam question - use it to spark a doubt thread, earn extra engagement coins, and give your students something to talk about beyond the syllabus.',
      preview:(
        <div style={{background:isDark?`${accent}10`:card,border:`1px solid ${accent}28`,borderRadius:12,padding:12}}>
          <div style={{display:'flex',gap:8,marginBottom:8}}>
            <span style={{color:accent,fontSize:9,fontWeight:700}}>🇮🇳 TODAY'S STORY</span>
          </div>
