  ...
  if (compact && !open) {
    return (
      <button
        ...
        style={{
          background: 'none', border: '1.5px dashed var(--color-accent, #D4AF37)', borderRadius: 12,
          padding: '10px 16px', cursor: 'pointer', color: 'var(--color-accent, #D4AF37)',
    ...
    >
      {!submitted ? (
        <>
          ...
          <p style={{ color: 'var(--color-muted, #64748B)', fontSize: 13, marginBottom: 16 }}>
          ...
          {[
            ...
            <div key={f.key} style={{ marginBottom: 12 }}>
              <label style={{ display: 'block', fontWeight: 600, color: 'var(--color-primary, #1E3A5F)',
          ...
          {error && <p style={{ color: 'var(--color-error, #EF4444)', fontSize: 12, marginBottom: 10 }}>{error}</p>}
          <button onClick={submit} style={{
            width: '100%', padding: '12px', borderRadius: 12, border: 'none',
            background: 'linear-gradient(135deg,var(--color-accent, #D4AF37),var(--color-accent-light, #E8C84A))',
            fontFamily: 'Poppins,sans-serif', fontWeight: 700,
            fontSize: 14, color: 'var(--color-primary, #1E3A5F)', cursor: 'pointer',
          }}>
            Submit Request →
          </button>
        </>
        ...
        <motion.div initial={{ scale: 0.8, opacity: 0 }}
          ...
          <h3 style={{ fontFamily: 'Poppins,sans-serif', fontWeight: 700, color: 'var(--color-primary, #1E3A5F)' }}>
            Request Sent!
          </h3>
          <p style={{ color: 'var(--color-muted, #64748B)', fontSize: 14, marginTop: 8 }}>
