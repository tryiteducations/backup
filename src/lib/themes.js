...
export const THEMES = {
  ...
  dark: {
    ...
    text:'var(--color-bg-muted-2, #F1F5F9)',       textLight:'#94A3B8',
    border:'#334155',     success:'var(--color-success, #22C55E)',
    error:'var(--color-error, #EF4444)',      warning:'#F59E0B',
    cardBg:'#1E293B',     cardText:'var(--color-bg-muted-2, #F1F5F9)',   cardAccent:'var(--color-accent, #D4AF37)',
    // ID card fix: always light text on dark cards
    idCardBg:'linear-gradient(135deg,#1E293B,#0F172A)',
    idCardText:'var(--color-bg-muted-2, #F1F5F9)', idCardId:'var(--color-accent, #D4AF37)',   idCardBorder:'rgba(212,175,55,0.5)',
