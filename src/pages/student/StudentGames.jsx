...
const GAMES = [
  ...
  { id:'battle',          name:'1v1 Battle',          emoji:'⚔️', color:'var(--color-accent, #C9A84C)', glow:'#C9A84C',
  ...
  { id:'case_cracker',    name:'Case Cracker',       emoji:'⚖️', color:'#DC2626', glow:'#DC2626',
  ...
  { id:'word_power',      name:'Word Power',         emoji:'🗣️', color:'#0D9488', glow:'#0D9488',
                ...
                <div style={{ padding:'12px' }}>
                  ...
                  <div style={{ display:'flex', gap:6 }}>
                    <button
                      ...
                      {unlocked ? (played>0 ? `▶️ Play (Lv.${level})` : '▶️ Start') : `🔒 ${game.tier}`}
                    </button>
                    {played > 0 && (
