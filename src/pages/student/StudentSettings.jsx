...
export default function StudentSettings() {
  ...
  const muted   = theme?.textLight ?? (isDark ? 'rgba(255,255,255,0.65)' : '#475569')
  const card    = theme?.surface ?? (isDark ? 'rgba(255,255,255,0.08)' : '#ffffff')
  const bdr     = theme?.border ?? (isDark ? 'rgba(255,255,255,0.15)' : '#CBD5E1')
                    ...
                    return (
                      <div key={t.id}
                        ...
                        <div style={{
                          ...
                          <div style={{height:20,background:t.isDark?(t.primaryDark||t.primary||'#0F172A'):(t.primary||'#1E3A5F'),display:'flex',alignItems:'center',padding:'0 7px',gap:4}}>
                          ...
                          <div style={{padding:'5px 7px',display:'flex',flexDirection:'column',gap:3,background:t.bg||'#F8FAFC'}}>
